...
class PlayList {
    ...
    private int minIndex(int start) {
        if (start < 0 || start > size-1)    {return -1;}
            ...
            for (int i = start; i < size;i++){
                if (tracks[i].getDuration()<minimumLength){
                    minimumLength = tracks[i].getDuration();
                    indexOfMinimum = i;
                }
            }
    ...
    public void sortedInPlace() {
        ...
        for (int i = 0; i < this.size; i++){
            ...
            this.tracks[i] = this.tracks[tempIndex];
            this.tracks[tempIndex] = temp;
        }
    }
}
